...
class ViewController: UIViewController {
    ...
    func setupTracks() {
            tracks = [
                Track(title: "T.G.G", artist: "Santiz", imageName: "tgg", fileName: "santiz"),
                Track(title: "Миллион аллых роз", artist: "Egor Kreed", imageName: "creed", fileName: "egor"),
                Track(title: "Сансара", artist: "Баста", imageName: "sansara", fileName: "basta"),
                Track(title: "Мурашки", artist: "V S X V PRiNCE", imageName: "murashki", fileName: "price"),
                Track(title: "I got love", artist: "Miyagi", imageName: "igl", fileName: "miyagi")
            ]
        }
